 ...
 * (Typically SDOs, SROs, COOs, and Marking Definitions).</p>
 * <br>
 ...
 */
@Documented
@Constraint(validatedBy = {StixDefaultTypeValueValidator.class, StixDefaultTypeValueBundleObjectValidator.class, StixDefaultTypeValueCyberObservableValidator.class})
