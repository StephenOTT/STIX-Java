...
import io.digitalstate.stix.sdo.IntrusionSet;
import io.digitalstate.stix.sdo.impl.properties.IntrusionSetProperties;
...
public class InstrusionSetSdo extends IntrusionSetProperties implements IntrusionSet {

    private static final String TYPE = "intrusion-set";

    public InstrusionSetSdo(String name){
        setId(generateId());
        setType(TYPE);
        setName(name);
    }
