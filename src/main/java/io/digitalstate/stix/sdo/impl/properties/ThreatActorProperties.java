...
public abstract class ThreatActorProperties extends CommonProperties{
    ...
    protected List<Enum<ThreatActorRole>> roles = null;
    protected List<String> goals = null;
    protected Enum<ThreatActorSophistication> sophistication = null;
    ...
    protected List<Enum<AttackMotivation>> personalMotivations = null;
}
