...
import io.digitalstate.stix.sdo.CourseOfAction;
import io.digitalstate.stix.sdo.impl.properties.CourseOfActionProperties;
...
public class CourseOfActionSdo extends CourseOfActionProperties implements CourseOfAction {

    private static final String TYPE = "course-of-action";

    public CourseOfActionSdo(String name){
        setId(generateId());
        setName(name);
        setType(TYPE);
    }
