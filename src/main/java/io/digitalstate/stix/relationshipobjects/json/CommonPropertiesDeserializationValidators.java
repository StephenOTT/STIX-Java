package io.digitalstate.stix.relationshipobjects.json;
...
public class CommonPropertiesDeserializationValidators {
     ...
     */
    public static void validateAllCommonProperties(JsonNode node, StixRelationshipObject object, String requiredType, boolean isLabelsRequired) throws IllegalArgumentException{
     ...
     */
    public static Optional<JsonNode> validateType(JsonNode node, String requiredType, StixRelationshipObject object) throws IllegalArgumentException{
     ...
     * @throws IllegalArgumentException
     */
    public static Optional<JsonNode> validateId(JsonNode node, StixRelationshipObject object) throws IllegalArgumentException{
     ...
     * @throws IllegalArgumentException
     */
    public static Optional<JsonNode> validateCreatedByRef(JsonNode node, StixRelationshipObject object) throws IllegalArgumentException{
     ...
     * @throws IllegalArgumentException
     */
    public static Optional<JsonNode> validateCreated(JsonNode node, StixRelationshipObject object) throws IllegalArgumentException{
     ...
     * @throws IllegalArgumentException
     */
    public static Optional<JsonNode> validateModified(JsonNode node, StixRelationshipObject object) throws IllegalArgumentException{
     ...
     * @throws IllegalArgumentException
     */
    public static Optional<JsonNode> validateRevoked(JsonNode node, StixRelationshipObject object) throws IllegalArgumentException{
     ...
     * @throws IllegalArgumentException
     */
    public static Optional<JsonNode> validateLabels(JsonNode node, StixRelationshipObject object, boolean isRequired) throws IllegalArgumentException{
     ...
     * @throws IllegalArgumentException
     */
    public static Optional<JsonNode> validateExternalRefs(JsonNode node, StixRelationshipObject object) throws IllegalArgumentException{
     ...
     * @throws IllegalArgumentException
     */
    public static Optional<JsonNode> validateObjectMarkingRefs(JsonNode node, StixRelationshipObject object) throws IllegalArgumentException{
     ...
     * @throws IllegalArgumentException
     */
    public static Optional<JsonNode> validateGranularMarkings(JsonNode node, StixRelationshipObject object) throws IllegalArgumentException{
