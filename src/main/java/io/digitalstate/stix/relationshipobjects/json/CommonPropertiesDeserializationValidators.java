...
public class CommonPropertiesDeserializationValidators {
     ...
     * @throws IllegalArgumentException
     */
    public static Optional<JsonNode> validateExternalRefs(JsonNode node, StixRelationshipObject object, JsonParser jp) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException
     */
    public static Optional<JsonNode> validateGranularMarkings(JsonNode node, StixRelationshipObject object, JsonParser jp) throws IllegalArgumentException {
